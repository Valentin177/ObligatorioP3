...
namespace LogicaAccesoDatos.Migrations
{
    ...
    [Migration("20231017175539_veinteuna")]
    partial class veinteuna
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmenazaEcosistema", b =>
                {
                    b.Property<int>("amenazasidAmenaza")
                        .HasColumnType("int");

                    b.Property<int>("ecosistemasidEcosistema")
                        .HasColumnType("int");

                    b.HasKey("amenazasidAmenaza", "ecosistemasidEcosistema");

                    b.HasIndex("ecosistemasidEcosistema");
            ...
            modelBuilder.Entity("AmenazaEspecie", b =>
                {
                    b.Property<int>("AmenazasEspecieidAmenaza")
                        .HasColumnType("int");

                    b.Property<int>("especiesidEspecie")
                        .HasColumnType("int");

                    b.HasKey("AmenazasEspecieidAmenaza", "especiesidEspecie");

                    b.HasIndex("especiesidEspecie");
            ...
            modelBuilder.Entity("EcosistemaEspecie", b =>
                {
                    b.Property<int>("ecosistemasHabitadosidEcosistema")
                        .HasColumnType("int");

                    b.Property<int>("especiesidEspecie")
                        .HasColumnType("int");

                    b.HasKey("ecosistemasHabitadosidEcosistema", "especiesidEspecie");
            ...
            modelBuilder.Entity("AmenazaEcosistema", b =>
                {
                    b.HasOne("LogicaNegocio.Dominio.Amenaza", null)
                        .WithMany()
                        .HasForeignKey("amenazasidAmenaza")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LogicaNegocio.Dominio.Ecosistema", null)
                        .WithMany()
                        .HasForeignKey("ecosistemasidEcosistema")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AmenazaEspecie", b =>
                {
                    b.HasOne("LogicaNegocio.Dominio.Amenaza", null)
                        .WithMany()
                        .HasForeignKey("AmenazasEspecieidAmenaza")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LogicaNegocio.Dominio.Especie", null)
                        .WithMany()
                        .HasForeignKey("especiesidEspecie")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EcosistemaEspecie", b =>
                {
                    b.HasOne("LogicaNegocio.Dominio.Ecosistema", null)
                        .WithMany()
                        .HasForeignKey("ecosistemasHabitadosidEcosistema")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
